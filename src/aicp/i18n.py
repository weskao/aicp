...
CATALOG: dict[str, str] = {
    ...
    "config_help_settings_io": "把 config.json 存成檔案，或載入另一台機器寫出的檔案。",
    "settings_export_q": "把目前的設定匯出到檔案 [⏎ 略過]：",
    "settings_export_done": "✓ 已寫入 %s（%s 個設定）",
    "settings_export_failed": "✗ 無法寫入 %s",
    "settings_import_q": "從檔案匯入設定 [⏎ 略過]：",
    "settings_import_empty": "✗ %s 裡沒有可匯入的設定",
    "settings_import_failed": "✗ 無法把匯入的設定存到 %s",
    "settings_import_done": "✓ 已匯入 %s 個設定",
    ...
    # ── Agents: the registry row, its report and the --agents verbs ─────────
    "agents_count": "✓ %s 個啟用中",
    "agents_count_off": "✓ %s 個啟用中 · %s 個已關閉",
    "agents_title": "AGENTS",
    "agents_state_builtin": "內建",
    "agents_state_overridden": "已覆寫",
    "agents_state_added": "自行新增",
    "agents_state_disabled": "已關閉",
    "agents_toggle_q": "要開啟／關閉哪一個？[1-%s，⏎ 略過]：",
    "agents_edit_hint": "  要新增或修改請用：aicp --agents set <name> executable=… config_dir=…",
    "agents_hint": "  aicp --agents set <name> executable=… · disable <name> · reset <name>",
    "agents_bad_verb": "✗ 不認得的 agents 動作：%s（可用：%s）",
    "agents_needs_name": "✗ %s 需要一個 agent 名稱",
    "agents_done_enabled": "✓ 已開啟 %s",
    "agents_done_disabled": "✓ 已關閉 %s",
    "agents_done_updated": "✓ 已更新 %s",
    "agents_done_added": "✓ 已新增 %s",
    "agents_done_reset": "✓ %s 已還原成內建定義",
    "agents_done_removed": "✓ 已移除 %s",
    "agents_pruned": "  已從儲存的 CLI 順序中移除：%s",
    "agents_next_run": "  下一次 aicp 就會採用",
    "agents_tui_keys": "↑↓ 選擇 · ⏎ 切換開關 · q 返回",
    "help_agents": "列出 agent 清單；或在 ~/.aicp/agents.json 裡 enable/disable/set/reset 其中一個",
